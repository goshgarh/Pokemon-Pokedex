      ...
      $('.my_all_links').click(function () {
          Promise.all(Promise_pokemon).then(function (values) {
              ...
              for (let k = 0; k < r1_values.length; k++) {
                  ...
                  for (let i = 0; i < r1_values[k].data.abilities.length; i++) {
                      shahdag[`${pokemons[k]}`].myAbilities.push(r1_values[k].data.abilities[i].ability.name);
                  }
      ...
      $('#inp_btn').click(function () {
          ...
          Promise_inp.then(function (values) {
              ...
              for (i = 0; i < r1_values.data.abilities.length; i++) {
                  shahdag[pokeman_name1].myAbilities.push(r1_values.data.abilities[i].ability.name);
              }
